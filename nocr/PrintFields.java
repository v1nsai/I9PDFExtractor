...
public class PrintFields
{
    ...
    {
//        PDDocument pdf = PDDocument.load(new File("nocr/testfiles/ver07_speedy_gonzales.pdf"));
        PDDocument pdf = PDDocument.load(new File("nocr/testfiles/v10_filled_desktop.pdf"));
