...
def setImageCoords(file, formNumber, page_number):
    ...
    if formNumber == '02/02/09':
        ...
        image_coords_020209 = {'LastName':(.055*width,.180*height,.37*width,.204*height),
                        ...
                        'DateOfBirth': (.689*width,.217*height,.95*width,.240*height),
                        'SocialSecurity': (.689*width,.254*height,.9*width,.275*height),
                        'State': (.345*width,.252*height,.58*width,.275*height),
                        'Zip': (.58*width,.252*height,.688*width,.275*height),
                        'EmailAddress': (),
                        'Telephone': (),
                        'Attestation': (.493*width,.292*height,.52*width,.365*height),
                        'Alien # for Permanent Residence': (.725*width,.325*height,.94*width,.345*height),
                        'Date Expiration of Work Authorization': (.805*width,.362*height,.94*width,.377*height),
                        'Alien # for Work Authorization': (.81*width,.346*height,.94*width,.36*height),
                        ...
                        'List A - DocumentTitle': (.151*width,.564*height,.363*width,.586*height),
                        'List A - IssuingAuthority': (.156*width,.586*height,.363*width,.605*height),
                        'List A - DocumentNumber': (.136*width,.606*height,.363*width,.625*height),
                        'List A - DocumentExpirationDate': (.221*width,.626*height,.363*width,.645*height),
                        'List A - DocumentTitle - Second Section': (),
                        'List A - IssuingAuthority - Second Section': (),
                        'List A - DocumentNumber - Second Section': (.136*width,.644*height,.363*width,.662*height),
                        'List A - DocumentExpirationDate - Second Section': (.219*width,.664*height,.363*width,.683*height),
                        'List B - DocumentTitle': (.386*width,.561*height,.64*width,.585*height),
                        'List B - IssuingAuthority': (.386*width,.586*height,.64*width,.605*height),
                        'List B - DocumentNumber': (.386*width,.606*height,.64*width,.6245*height),
                        'List B - DocumentExpirationDate': (.386*width,.626*height,.64*width,.6445*height),
                        'List C - DocumentTitle': (.706*width,.561*height,.95*width,.585*height),
                        'List C - IssuingAuthority': (.706*width,.586*height,.95*width,.605*height),
                        'List C - DocumentNumber': (.706*width,.606*height,.95*width,.6245*height),
                        'List C - DocumentExpirationDate': (.706*width,.6245*height,.95*width,.6445*height),
                        'DateOfHire': (.167*width,.711*height,.278*width,.726*height),
                        'Name of Employee Representative': (.396*width,.752*height,.698*width,.774*height),
                        'Title': (.698*width,.752*height,.95*width,.774*height),
                        'EmployerBusinessName': (.05*width,.7875*height,.698*width,.808*height),
                        'EmployerStreetAddress': (),
                        'Date Signed by Employer': (.699*width,.7875*height,.94*width,.807*height),
        ...
        image_coords_080709 = {'LastName':(.055*width,.18*height,.37*width,.205*height),
                        ...
                        'Zip': (.58*width,.253*height,.68*width,.275*height),
                        'DateOfBirth': (.693*width,.218*height,.94*width,.239*height),
                        'SocialSecurity': (.692*width,.2525*height,.9*width,.276*height),
                        'Attestation': (.493*width,.29*height,.519*width,.367*height),
                        ...
                        'List A - IssuingAuthority': (.153*width,.586*height,.358*width,.605*height),
                        'List A - DocumentNumber': (.133*width,.607*height,.358*width,.622*height),
                        'List A - DocumentExpirationDate': (.225*width,.625*height,.351*width,.64*height),
                        'List B - DocumentTitle': (.392*width,.561*height,.625*width,.583*height),
                        'List B - IssuingAuthority': (.392*width,.586*height,.625*width,.605*height),
                        'List B - DocumentNumber': (.392*width,.609*height,.625*width,.623*height),
                        'List B - DocumentExpirationDate': (.392*width,.625*height,.625*width,.643*height),
                        'List C - DocumentTitle': (.71*width,.561*height,.945*width,.586*height),
                        'List C - IssuingAuthority': (.71*width,.586*height,.945*width,.605*height),
                        'List C - DocumentNumber': (.71*width,.607*height,.945*width,.625*height),
                        'List C - DocumentExpirationDate': (.71*width,.625*height,.945*width,.643*height),
        ...
        image_coords_050787 = {'LastName':(.075*width,.133*height,.38*width,.1525*height),
                ...
                'City': (.38*width,.162*height,.56*width,.182*height),
                ...
                'Alien # for Permanent Residence': (.503*width,.24*height,.655*width,.256*height),
                'Date Expiration of Work Authorization': (.62*width,.273*height,.78*width,.285*height),
                'Alien # for Work Authorization': (.732*width,.26*height,.911*width,.272*height),
                'Admission # for Work Authorization': (.235*width,.273*height,.369*width,.285*height),
                'I-94 Admission Number': (),
                'ForeignPassport': (),
                'Country of Issuance': (),
                ...
                'List A - DocumentNumber': (.076*width,.782*height,.315*width,.797*height),
                ...
                'List B - DocumentNumber': (.3913*width,.782*height,.63*width,.797*height),
                ...
                'List C - DocumentNumber': (.712*width,.782*height,.95*width,.797*height),
                ...
                'Date Signed by Employer': (.785*width,.935*height,.95*width,.953*height),
                'List A - DocumentTitle - Third Section': (),
                'List A - IssuingAuthority - Third Section': (),
                'List A - DocumentNumber - Third Section': (),
                'List A - DocumentExpirationDate - Third Section': (),
        ...
        image_coords_060507 = {'LastName':(.055*width,.197*height,.36*width,.221*height),
                ...
                'City': (.055*width,.27*height,.35*width,.291*height),
                'State': (.35*width,.27*height,.57*width,.291*height),
                'Zip': (.58*width,.27*height,.685*width,.291*height),
                ...
                'ForeignPassport': (),
                'Country of Issuance': (),
                'TranslatorName': (.515*width,.45*height,.88*width,.469*height),
                'TranslatorAddress': (.1*width,.48*height,.677*width,.497*height),
                'TranslatorDateOfSignature': (.678*width,.482*height,.9*width,.497*height),
                'List A - DocumentTitle': (.14*width,.561*height,.36*width,.586*height),
        ...
        image_coords_030813_pg7 = {'LastName':(.065*width,.224*height,.345*width,.244*height),
                'FirstName': (.346*width,.224*height,.58*width,.244*height), 
                'MiddleInitial': (.58*width,.224*height,.66*width,.244*height),
                'MaidenName': (.667*width,.224*height,.94*width,.244*height),
                'StreetAddress': (.064*width,.263*height,.39*width,.285*height),
                'City': (.502*width,.263*height,.72*width,.285*height),
                'State': (.732*width,.263*height,.803*width,.285*height),
                'Zip': (.806*width,.263*height,.929*width,.285*height),
                'DateOfBirth': (.065*width,.30*height,.23*width,.325*height),
                'SocialSecurity': (.232*width,.30*height,.406*width,.325*height),
                'EmailAddress': (.41*width,.301*height,.75*width,.325*height),
                'Telephone': (.757*width,.301*height,.94*width,.325*height),
                ...
                'Date Expiration of Work Authorization': (.535*width,.447*height,.662*width,.47*height),
                'Alien # for Work Authorization': (.388*width,.505*height,.62*width,.53*height),
                'I-94 Admission Number': (.3*width,.53*height,.62*width,.56*height),
                'Foreign Passport': (.296*width,.599*height,.72*width,.628*height),
                'Country of Issuance': (.257*width,.628*height,.72*width,.652*height),
                'TranslatorName': (.064*width,.858*height,.94*width,.874*height),
                'TranslatorAddress': (.065*width,.892*height,.4*width,.915*height),
                'TranslatorDateOfSignature': (.752*width,.821*height,.94*width,.838*height)}
    
    elif (formNumber == '03/08/13') & (page_number == 8):
        global image_coords_030813_pg8
        image_coords_030813_pg8 = {'List A - DocumentTitle': (.064*width,.205*height,.344*width,.22*height),
                'List A - IssuingAuthority': (.064*width,.233*height,.344*width,.248*height),
                'List A - DocumentNumber': (.064*width,.259*height,.344*width,.276*height),
                'List A - DocumentExpirationDate': (.064*width,.2905*height,.344*width,.308*height),
                'List A - DocumentTitle - Second Section': (.064*width,.32*height,.344*width,.336*height),
                'List A - IssuingAuthority - Second Section': (.064*width,.3475*height,.344*width,.362*height),
                'List A - DocumentNumber - Second Section': (.064*width,.3738*height,.344*width,.390*height),
                'List A - DocumentExpirationDate - Second Section': (.064*width,.401*height,.344*width,.4165*height),
                'List B - DocumentTitle': (.361*width,.205*height,.65*width,.22*height),
                'List B - IssuingAuthority': (.361*width,.234*height,.65*width,.247*height),                
                'List B - DocumentNumber': (.361*width,.26*height,.65*width,.276*height),
                'List B - DocumentExpirationDate': (.361*width,.2905*height,.65*width,.308*height),
                'List C - DocumentTitle': (.655*width,.205*height,.94*width,.22*height),
                'List C - IssuingAuthority': (.655*width,.233*height,.94*width,.249*height),
                'List C - DocumentNumber': (.655*width,.26*height,.94*width,.276*height),
                'List C - DocumentExpirationDate': (.655*width,.2905*height,.94*width,.308*height),
                'DateOfHire': (.449*width,.603*height,.59*width,.616*height),
                'Name of Employee Representative': (.065*width,.678*height,.55*width,.7*height),
                'Title': (.61*width,.642*height,.9*width,.66*height),
                'EmployerBusinessName': (.577*width,.678*height,.94*width,.695*height),
                'EmployerStreetAddress': (.064*width,.714*height,.496*width,.737*height),
                'Date Signed by Employer': (.454*width,.642*height,.604*width,.662*height),
                'List A - DocumentTitle - Third Section': (.064*width,.43*height,.345*width,.446*height),
                'List A - IssuingAuthority - Third Section': (.064*width,.46*height,.345*width,.473*height),
                'List A - DocumentNumber - Third Section': (.064*width,.487*height,.345*width,.504*height),
                'List A - DocumentExpirationDate - Third Section': (.064*width,.52*height,.345*width,.535*height),
                'Employee Info from Section 1': ()}
        ...
        image_coords_111416_pg2 = {'List A - DocumentTitle': (.06*width,.232*height,.335*width,.249*height),
                        'List A - IssuingAuthority': (.06*width,.263*height,.335*width,.278*height),
                        'List A - DocumentNumber': (.06*width,.29*height,.335*width,.306*height),
                        'List A - DocumentExpirationDate': (.06*width,.318*height,.335*width,.334*height),
                        'List A - DocumentTitle - Second Section': (.06*width,.35*height,.335*width,.366*height),
                        'List A - IssuingAuthority - Second Section': (.06*width,.38*height,.335*width,.394*height),
                        'List A - DocumentNumber - Second Section': (.06*width,.405*height,.335*width,.421*height),
                        'List A - DocumentExpirationDate - Second Section': (.06*width,.434*height,.335*width,.449*height),
                        'List B - DocumentTitle': (.361*width,.232*height,.65*width,.25*height),
                        'List B - IssuingAuthority': (.361*width,.263*height,.65*width,.278*height),
                        'List B - DocumentNumber': (.361*width,.29*height,.65*width,.306*height),
                        'List B - DocumentExpirationDate': (.361*width,.318*height,.65*width,.334*height),
                        'List C - DocumentTitle': (.658*width,.232*height,.94*width,.25*height),
                        'List C - IssuingAuthority': (.658*width,.263*height,.94*width,.278*height),
                        'List C - DocumentNumber': (.658*width,.29*height,.94*width,.306*height),
                        'List C - DocumentExpirationDate': (.658*width,.318*height,.94*width,.334*height),
                        ...
                        'List A - DocumentTitle - Third Section': (.06*width,.465*height,.335*width,.48*height),
        ...
        image_coords_071717_pg1 = {'LastName':(.065*width,.24*height,.347*width,.264*height),
                        'FirstName': (.35*width,.24*height,.592*width,.264*height), 
                        'MiddleInitial': (.596*width,.245*height,.694*width,.264*height),
                        ...
                        'Zip': (.808*width,.279*height,.945*width,.301*height),
                        ...
                        'Alien # for Permanent Residence': (.575*width,.449*height,.78*width,.466*height),
                        'Date Expiration of Work Authorization': (.575*width,.47*height,.72*width,.486*height),
                        ...
                        'Country of Issuance': (.23*width,.622*height,.6*width,.64*height),
        ...
        image_coords_071717_pg2 = {'List A - DocumentTitle': (.068*width,.231*height,.34*width,.248*height),
                        'List A - IssuingAuthority': (.069*width,.261*height,.34*width,.276*height),
                        'List A - DocumentNumber': (.069*width,.287*height,.34*width,.304*height),
                        'List A - DocumentExpirationDate': (.069*width,.317*height,.34*width,.333*height),
                        'List A - DocumentTitle - Second Section': (.069*width,.348*height,.34*width,.364*height),
                        'List A - IssuingAuthority - Second Section': (.069*width,.377*height,.34*width,.393*height),
                        'List A - DocumentNumber - Second Section': (.069*width,.404*height,.34*width,.419*height),
                        'List A - DocumentExpirationDate - Second Section': (.069*width,.432*height,.34*width,.448*height),
                        'List B - DocumentTitle': (.366*width,.233*height,.655*width,.25*height),
                        'List B - IssuingAuthority': (.366*width,.261*height,.655*width,.277*height),
                        'List B - DocumentNumber': (.366*width,.287*height,.655*width,.304*height),
                        'List B - DocumentExpirationDate': (.366*width,.317*height,.655*width,.333*height),
                        'List C - DocumentTitle': (.658*width,.233*height,.94*width,.249*height),
                        ...
                        'Name of Employee Representative': (.069*width,.684*height,.64*width,.703*height),
                        'Title': (.626*width,.649*height,.945*width,.668*height),
                        'EmployerBusinessName': (.666*width,.688*height,.945*width,.703*height),
                        'EmployerStreetAddress': (.069*width,.722*height,.5*width,.737*height),
                        'Date Signed by Employer': (.443*width,.649*height,.623*width,.669*height),
                        'List A - DocumentTitle - Third Section': (.068*width,.462*height,.34*width,.478*height),
                        ...
                        'Employee Info from Section 1 - LastName': (.274*width,.175*height,.514*width,.191*height),
                        'Employee Info from Section 1 - FirstName':(.516*width,.175*height,.708*width,.191*height), 
                        'Employee Info from Section 1 - Middle Initial': (.71*width,.177*height,.748*width,.191*height)
                        }
...
def removeRandomPixels(data):
    ...
    #clean up any remaining random pixels (two columns with a pixel with none in
    #columns next to it)
    for i in range(width-4):
        pixels = pixel_cols[i:i+4]
        pixel1 = pixels[0]
        pixel2 = pixels[1]
        pixel3 = pixels[2]
        pixel4 = pixels[3]
        if (pixel2 < height) & (pixel3 < height) & (pixel1 == height) & (pixel4 == height):
            data[:,i+1:i+2] = 1
    ...
    #clean up any remaining random pixels (rows with a pixel with none in
    #rows next to it)
    for i in range(height-3):
        pixels = pixel_rows[i:i+3]
        pixel1 = pixels[0]
        pixel2 = pixels[1]
        pixel3 = pixels[2]
        if (pixel2 < width) & (pixel1 == width) & (pixel3 == width):
            data[i+1,:] = 1    
    
    #clean up any remaining random pixels (two rows with a pixel with none in
    #rows next to it)
    for i in range(height-4):
        pixels = pixel_rows[i:i+4]
        pixel1 = pixels[0]
        pixel2 = pixels[1]
        pixel3 = pixels[2]
        pixel4 = pixels[3]
        if (pixel2 < width) & (pixel3 < width) & (pixel1 == width) & (pixel4 == width):
            data[i+1:i+2,:] = 1 

    #try to clean up the data output for random pixels in bottom of image
    pixel_rows = pixel_rows[::-1] #reverse array to start from bottom
    bottom_pixel_count = 0
    gap = 0
    main_pixel_count = 0
    for i in range(height):
        if (bottom_pixel_count == 0) & (gap == 0):
            if pixel_rows[i] < width:
                bottom_pixel_count += 1 
            else:
                break
        elif (bottom_pixel_count > 0) & (gap == 0):
            if pixel_rows[i] < width:
                bottom_pixel_count += 1
            else:
                gap += 1
    ...
    if (bottom_pixel_count > 0) & (bottom_pixel_count < 10) & (gap > 5) & (main_pixel_count > 16):
        data[height-bottom_pixel_count:height] = 1   
            
    return(data)

def removeLines(data):
    '''
    @@data data array of image
    Takes in an image and removes horizontal and vertical lines that take up
    large portion of the image and are thus assumed to not be text
    '''
    col_threshold = 0.17
...
def autoCropImage(data, border = 3):
    '''
    @@data data array of image
    ...
    if np.mean(data) < .995:  
        ...
        non_empty_columns = np.where(data.min(axis=0)<0.3)[0]
        if (min(non_empty_columns) > border) & (len(non_empty_columns) > border):
            cropBox = (0, height, min(non_empty_columns)-border, width)
            image_data_new = data[cropBox[0]:cropBox[1], cropBox[2]:cropBox[3]]
            #need to re-calculate height and width
            height, width = image_data_new.shape
        else:
            image_data_new = data
        #Crop the right-side of the image
        non_empty_columns = np.where(image_data_new.min(axis=0)<0.3)[0]
        if (width - max(non_empty_columns) > border) & (len(non_empty_columns) > border):
            cropBox = (0, height, 0, max(non_empty_columns)+border)
            image_data_new = image_data_new[cropBox[0]:cropBox[1], cropBox[2]:cropBox[3]]
            #need to re-calculate height and width
            height, width = image_data_new.shape
        #Crop the top of the image
        non_empty_rows = np.where(image_data_new.min(axis=1)<0.3)[0]
        if (min(non_empty_rows) > border) & (min(non_empty_rows) < height/2):
            cropBox = (min(non_empty_rows)-border, height, 0, width)
            image_data_new = image_data_new[cropBox[0]:cropBox[1], cropBox[2]:cropBox[3]]
            #need to re-calculate height and width
            height, width = image_data_new.shape
        #Crop the bottom of the image
        non_empty_rows = np.where(image_data_new.min(axis=1)<0.3)[0]
        if (height - max(non_empty_rows) > border) & (height - max(non_empty_rows) < height/2):
            cropBox = (0, max(non_empty_rows)+border, 0, width)
            image_data_new = image_data_new[cropBox[0]:cropBox[1], cropBox[2]:cropBox[3]]
            #need to re-calculate height and width
            height, width = image_data_new.shape
...
def autoCropImage2(data):
    ...
    if np.mean(data) < .995:  
        ...
        non_empty_columns = np.where(data.min(axis=0)<0.3)[0]
        non_empty_rows = np.where(data.min(axis=1)<0.3)[0]
        #check to see if it was already cropped
        if (min(non_empty_columns) == 3) & (min(non_empty_rows) == 3) & (height - max(non_empty_rows) == 3) & (width - max(non_empty_columns) == 3):
            return(data)   
        elif (min(non_empty_columns) > 3) & (min(non_empty_rows) > 3) & (height - max(non_empty_rows) > 3) & (width - max(non_empty_columns) > 3):
            cropBox = (min(non_empty_rows), max(non_empty_rows), min(non_empty_columns), max(non_empty_columns))
            image_data_new = data[cropBox[0]-3:cropBox[1]+3, cropBox[2]-3:cropBox[3]+3]
            return(image_data_new)
        else:
            return(data)
    else:
...
for i in range(len(images)):
    ...
    for key, value in crops.items():
        ...
        if key == "Attestation":
            ...
            data = np.array(PIL.Image.open(crops[key][0]))
            data = enhance(data)
            data = removeLines(data)
            data = removeRandomPixels(data)
            data = removeBorderLines(data)
            data = autoCropImage(data, border = 4)
            data = removeBorderLines(data, threshold = .3)
            data = removeRandomPixels(data)
            data = autoCropImage(data, border = 4)
            im = PIL.Image.fromarray(np.uint8(data*255))
...
symbols_to_remove = '[().?|,`_~!:;><*&/—\^%$§‘»-]'
street_symbols_to_remove = '[()?|,`_~!:;><*&/—\^%$§»]'

#create a dictionary to get the text value needed 
attestation_dict = {'box1': 'USC',
                    'box2': 'Nat',
                    'box3': 'LPR',
                    'box4': 'EAD',
                    'no box': 'None'
...
for i in range(len(df_formatted)):
    ...
    if (df_formatted['City'][i] != None) and (df_formatted['City'][i] != ' '):
        ...
        df_formatted['City'][i] = df_formatted['City'][i].strip("i")
    ...
    if (df_formatted['State'][i] != None) and (df_formatted['State'][i] != ' '):
        ...
        df_formatted['State'][i] = df_formatted['State'][i].strip("i")
        
    #CLEAN STREET ADDRESS: remove symbols of sentences
    if (df_formatted['StreetAddress'][i] != None) and (df_formatted['StreetAddress'][i] != ' '):
        df_formatted['StreetAddress'][i] = re.sub(street_symbols_to_remove, "", df_formatted['StreetAddress'][i])
        df_formatted['StreetAddress'][i] = df_formatted['StreetAddress'][i].strip("'")
    ...
    #CLEAN TRANSLATOR NAME: remove symbols
    if (df_formatted['TranslatorName'][i] != None) and (df_formatted['TranslatorName'][i] != ' '):
        df_formatted['TranslatorName'][i] = re.sub(street_symbols_to_remove, "", df_formatted['TranslatorName'][i])
        df_formatted['TranslatorName'][i] = df_formatted['TranslatorName'][i].strip("'")
...
columns = ['LastName','FirstName', 'DateOfBirth', 'SocialSecurity', 'Attestation',
           ...
           'StreetAddress', 'City', 'State', 'Zip', 'TranslatorName', 'I-94 Admission Number',
           'List A - DocumentTitle', 'List A - DocumentNumber', 'Foreign Passport',
...
for i in range(len(df_formatted)):
    ...
    if (df_clean['Attestation'][i] == 'USC') | (df_clean['Attestation'][i] == 'Nat'):
        AlienAdmissionNumber.append(' ')
    elif (df_clean['Attestation'][i] == 'LPR'):
        AlienAdmissionNumber.append(df_clean['Alien # for Permanent Residence'][i])            
    elif (df_clean['Attestation'][i] == 'EAD'):
        if (df_clean['Alien # for Work Authorization'][i] != None) & (df_clean['Alien # for Work Authorization'][i] != 'NA'):
            AlienAdmissionNumber.append(df_clean['Alien # for Work Authorization'][i])  
        elif (df_clean['I-94 Admission Number'][i] != None) & (df_clean['I-94 Admission Number'][i] != 'NA'):
            AlienAdmissionNumber.append(df_clean['I-94 Admission Number'][i])  
        else:
            AlienAdmissionNumber.append(df_clean['Foreign Passport'][i])                                                   
    else:
        AlienAdmissionNumber.append(' ')
...
#Convert to JSON and add that it went through OCR pipeline
df_clean_json = json.loads((df_clean.to_json))
df_clean_json['Pipeline'] = 'OCR'
        
output = json.dumps(df_clean_json)
